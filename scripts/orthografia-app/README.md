...
Εφαρμογή υπαγόρευσης για εκμάθηση ελληνικής ορθογραφίας (Α΄–Στ΄ Δημοτικού, ΚΝΕ).
...
- Τάξεις Α΄–Στ΄, 4 τρόποι εξάσκησης (υπαγόρευση, αναζήτηση, επιλογή, πρόταση)
- **Κανόνας της εβδομάδας** — 5 λέξεις ανά ενότητα κανόνα
- **FSRS** επανάληψη (ts-fsrs) + εξαγωγή/εισαγωγή προόδου
