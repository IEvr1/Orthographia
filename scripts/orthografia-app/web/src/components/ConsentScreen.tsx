      ...
      <div className="legal-card">
        ...
        <section className="legal-section">
          ...
          <ul className="legal-list">
            ...
            <li>Αναγνωριστικό συσκευής για συγχρονισμό με άλλες συσκευές (αν ενεργοποιηθεί)</li>
            <li>Email λογαριασμού γονέα (μέσω Clerk) για συνδρομή και συγχρονισμό με άλλες συσκευές</li>
