      ...
      <div className="legal-card legal-card--wide">
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            χρήστες λαμβάνουν δωρεάν δοκιμή 5 ημερών με πρόσβαση σε όλες τις τάξεις και τους
            τρόπους εξάσκησης. Μετά τη δοκιμή, η δωρεάν έκδοση περιλαμβάνει όλες τις τάξεις
            (Β΄–Στ΄). Η πλήρης πρόσβαση (απεριόριστη εξάσκηση, όλοι οι τρόποι) απαιτεί ενεργή
            συνδρομή.
          </p>
        </section>
